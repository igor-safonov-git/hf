"""
Seed demo data for Huntflow schema
...
# Monkey patch for SQLite compatibility
...
STATUS_TYPES = ["New", "In Progress", "Rejected", "Offer", "Hired"]
...
STATUSES = [
    ...
    {"id": 11, "name": "Rejected - No Show", "type": "Rejected", "order": 11, "removed": False, "stay_duration": None},
]
...
def create_vacancy(v_id):
    ...
    return {
        ...
        "multiple": random.choice([True, False, False]),  # Most are single positions
...
with engine.connect() as conn:
    ...
    for r in RECRUITERS + HIRING_MANAGERS:
        recruiter_data.append({
            ...
            "email": r["email"],
            "type": r["type"],
            "member": r["id"],  # Same as ID for simplicity
